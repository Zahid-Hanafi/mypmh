...
<div class="mb-8">
    <div class="flex items-center gap-3 mb-2">
        ...
        <h1 class="text-2xl lg:text-3xl font-bold text-gray-900">Edit Application</h1>
    </div>
    <p class="text-gray-500 ml-8">Update your application details</p>
</div>
...
<div class="max-w-4xl">
    <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 lg:p-8">
        ...
        <?= $this->Form->create($application, ['class' => 'space-y-6', 'id' => 'editForm']) ?>
        ...
        <div class="bg-gray-50 rounded-xl p-6 border border-gray-200">
            ...
            <p class="text-xs text-gray-400 mt-3">
                ...
                To update your information, please go to <a href="<?= $this->Url->build(['controller' => 'Users', 'action' => 'profile']) ?>" class="text-pmh-purple hover:underline">My Profile</a>. Changes will be reflected here automatically.
            </p>
        </div>
        ...
        <div class="bg-purple-50 rounded-xl p-6 border border-purple-100">
            <label class="block text-sm font-semibold text-gray-700 mb-2">
                <i class="fas fa-calendar-check text-pmh-purple mr-2"></i>Interview Session <span class="text-red-500">*</span>
            </label>
...
<div id="confirmModal" class="fixed inset-0 bg-black/50 z-50 hidden items-center justify-center p-4">
    <div class="bg-white rounded-2xl max-w-lg w-full p-8 shadow-2xl">
        <div class="text-center mb-6">
            ...
            <h3 class="text-xl font-bold text-gray-900 mb-2">Confirm Changes</h3>
        </div>
        <p class="text-gray-600 text-center mb-6">
            Are you sure you want to update your application? Make sure all information is accurate before proceeding.
        </p>
